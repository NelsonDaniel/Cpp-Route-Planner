...
```
git clone https://github.com/nelsondaniel/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:nelsondaniel/CppND-Route-Planning-Project.git --recurse-submodules
```
