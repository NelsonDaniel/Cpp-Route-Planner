...
```
git clone https://github.com/nelsondaniel/Cpp-Route-Planner.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:nelsondaniel/Cpp-Route-Planner.git --recurse-submodules
```
